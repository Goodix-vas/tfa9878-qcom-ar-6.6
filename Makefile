...
snd-soc-aud3003x-objs := aud3003x.o aud3003x-dump.o
snd-soc-aud3003x-5p-objs := aud3003x-5pin.o
snd-soc-aud3003x-6p-objs := aud3003x-6pin.o
...
obj-$(CONFIG_SND_SOC_AUD3003X) += snd-soc-aud3003x.o
obj-$(CONFIG_SND_SOC_AUD3003X_5PIN)	+= snd-soc-aud3003x-5p.o
obj-$(CONFIG_SND_SOC_AUD3003X_6PIN)	+= snd-soc-aud3003x-6p.o
...
obj-$(CONFIG_SND_SOC_TAS2562)	+= tas2562/
obj-$(CONFIG_SND_SOC_TFA9878)	+= tfa9878/
